...
TEMPLATES = {
    ...
    "commons": '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 630" width="1200" height="630"><defs><linearGradient id="g" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#152540"/><stop offset="100%" style="stop-color:#1e3555"/></linearGradient></defs><rect width="1200" height="630" fill="url(#g)"/><path d="M 200,400 Q 400,250 600,330 Q 800,410 1000,260" fill="none" stroke="#6db0e8" stroke-width="2" opacity="0.45"/><path d="M 150,280 Q 400,380 650,300 Q 900,220 1050,400" fill="none" stroke="#6db0e8" stroke-width="1.8" opacity="0.4"/><path d="M 250,200 Q 450,300 600,250 Q 800,200 950,350" fill="none" stroke="#4a90c9" stroke-width="1.5" opacity="0.35"/><path d="M 300,450 Q 500,420 700,470 Q 900,520 1050,460" fill="none" stroke="#4a90c9" stroke-width="1.5" opacity="0.3"/><circle cx="300" cy="280" r="14" fill="#7ec0f5" opacity="0.75"/><circle cx="300" cy="280" r="32" fill="#7ec0f5" opacity="0.13"/><circle cx="650" cy="320" r="14" fill="#7ec0f5" opacity="0.75"/><circle cx="650" cy="320" r="32" fill="#7ec0f5" opacity="0.13"/><circle cx="950" cy="300" r="14" fill="#7ec0f5" opacity="0.75"/><circle cx="950" cy="300" r="32" fill="#7ec0f5" opacity="0.13"/><line x1="300" y1="280" x2="650" y2="320" stroke="#6db0e8" stroke-width="1.5" opacity="0.4"/><line x1="650" y1="320" x2="950" y2="300" stroke="#6db0e8" stroke-width="1.5" opacity="0.4"/><line x1="300" y1="280" x2="950" y2="300" stroke="#6db0e8" stroke-width="1" opacity="0.25"/><circle cx="450" cy="380" r="6" fill="#7ec0f5" opacity="0.55"/><circle cx="800" cy="220" r="6" fill="#7ec0f5" opacity="0.55"/><circle cx="500" cy="180" r="5" fill="#7ec0f5" opacity="0.5"/><circle cx="850" cy="440" r="5" fill="#7ec0f5" opacity="0.5"/><circle cx="200" cy="430" r="4" fill="#7ec0f5" opacity="0.45"/><circle cx="1050" cy="200" r="4" fill="#7ec0f5" opacity="0.45"/><circle cx="180" cy="180" r="4" fill="#7ec0f5" opacity="0.4"/><circle cx="1020" cy="480" r="4" fill="#7ec0f5" opacity="0.4"/><line x1="300" y1="280" x2="450" y2="380" stroke="#6db0e8" stroke-width="0.8" opacity="0.3"/><line x1="650" y1="320" x2="450" y2="380" stroke="#6db0e8" stroke-width="0.8" opacity="0.3"/><line x1="650" y1="320" x2="800" y2="220" stroke="#6db0e8" stroke-width="0.8" opacity="0.3"/><line x1="950" y1="300" x2="800" y2="220" stroke="#6db0e8" stroke-width="0.8" opacity="0.3"/><line x1="300" y1="280" x2="500" y2="180" stroke="#6db0e8" stroke-width="0.6" opacity="0.25"/><line x1="950" y1="300" x2="850" y2="440" stroke="#6db0e8" stroke-width="0.6" opacity="0.25"/></svg>',
